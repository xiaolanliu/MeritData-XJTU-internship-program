...
class Model(nn.Module):
    ...
    def forward(self, x, factor, y):
        ...
        # plt.plot(labels[0], label='True Values', color='blue')
        # plt.plot(outputs[0], label='Predicted Values', color='red')
        # plt.xlabel('Time Step')
        # plt.ylabel('Value')
        # plt.title(f'True Values vs Predicted Values for Sample')
        # plt.legend()
        # plt.show()
