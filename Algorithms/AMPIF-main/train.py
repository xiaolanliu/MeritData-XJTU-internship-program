...
import warnings
import os
from utils import load_elec_dataset
...
class model_init:
    def __init__(self, args):
        ...
        self.data = load_elec_dataset(args)
...
def Args():
    ...
    parser.add_argument('--data_name', default='Industrial-Plastic_Manufacturer(1)', type=str,
                        choices=['Industrial-Plastic_Manufacturer(1)', 'Commercial-450-bed Hospital(1)', 'Reference-Secondary_School(1)', 'ETTm2'], help='dataset type')
    ...
    parser.add_argument('--epoch', default=20, type=float, help='Number of training epoch')
